...
export function HeroNumber({ echtesNetto, gewinn }: HeroNumberProps) {
  ...
  return (
    <div className="text-center py-6 animate-fade-up">
      ...
      <p className="text-5xl sm:text-6xl lg:text-7xl font-bold text-sb-green num-transition tracking-tight font-mono" aria-live="polite" aria-atomic="true">
        {formatted}
      </p>
      <div className="flex items-center justify-center gap-3 mt-4">
        <Badge variant="outline" className="bg-sb-green-soft text-sb-green border-sb-green/30 font-mono">
