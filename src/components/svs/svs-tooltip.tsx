...
const definitions: Record<string, string> = {
  ...
  Höchstbeitragsgrundlage:
    'Der maximale Betrag (€ 84.840/Jahr), auf den SVS-Beiträge berechnet werden. Einkommen darüber ist beitragsfrei.',
  Geringfügigkeitsgrenze:
    'Unter € 6.221,28 Jahresgewinn sind Sie von der Pflichtversicherung bei der SVS ausgenommen.',
    ...
    <TooltipProvider delayDuration={200}>
      <Tooltip>
        <TooltipTrigger asChild>
          <span className="inline-flex items-center gap-0.5 cursor-help border-b border-dashed border-blue-400 text-blue-600 font-medium">
            {term}
        ...
        <TooltipContent
          side="top"
          className="max-w-[280px] bg-slate-800 text-white border-slate-700 text-xs leading-relaxed"
        >
          <p>{content}</p>
        </TooltipContent>
      </Tooltip>
