  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="prose prose-slate max-w-none space-y-6">
          ...
          {/* 2. Überblick */}
          <section>
            <h2 className="text-xl font-semibold mb-3">2. Ueberblick der Verarbeitungen</h2>
            <p>
              Die folgende Uebersicht fasst die Arten der verarbeiteten Daten und die Zwecke ihrer
          ...
          <section>
            ...
            <p>
              Im Folgenden erhalten Sie eine Uebersicht der Rechtsgrundlagen der DSGVO, auf deren
              Basis wir personenbezogene Daten verarbeiten:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong>Einwilligung (Art. 6 Abs. 1 lit. a DSGVO)</strong> – Die betroffene Person hat ihre Einwilligung in die Verarbeitung der sie betreffenden personenbezogenen Daten fuer einen oder mehrere bestimmte Zwecke gegeben.</li>
              <li><strong>Vertragserfullung (Art. 6 Abs. 1 lit. b DSGVO)</strong> – Die Verarbeitung ist fuer die Erfullung eines Vertrags, dessen Vertragspartei die betroffene Person ist, oder zur Durchfuhrung vorvertraglicher Massnahmen erforderlich.</li>
          ...
          <section>
            ...
            <p>
              Netlify verfuegt ueber EU-Standardvertragsklauseln als Garantie fuer die Datenuebermittlung
          ...
          <section>
            ...
            <p>
              Nutzer koennen auf unserer Website ein Benutzerkonto anlegen. Im Rahmen der Registrierung
            ...
            <p>
              Die Registrierung ist erforderlich, um erweiterte Funktionen nutzen zu koennen (z.B.
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>Berechnungsergebnisse (Beitragsgrundlage, endgueltige SVS, Nachzahlung, Steuerersparnis)</li>
              <li>Zeitpunkt der Berechnung</li>
            </ul>
            <p>
              <strong>Ohne Registrierung</strong> werden keinerlei Berechnungsdaten gespeichert oder an
              Server uebermittelt. Die Berechnungen erfolgen ausschliesslich lokal in Ihrem Browser.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Fuer kostenpflichtige Abonnements nutzen wir <strong>Lemon Squeezy</strong> (Lemon Squeezy, LLC,
            ...
            <p>
              ...
              Verwaltungs-URLs ueber einen verschluesselten Webhook.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Diese Speicherung ist fuer den Betrieb der Website technisch erforderlich und erfolgt
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>Sie Ihre ausdrueckliche Einwilligung dazu erteilt haben (Art. 6 Abs. 1 lit. a DSGVO)</li>
          ...
          <section>
            ...
            <p>
              ...
              Socket Layer) in Verbindung mit der jeweils hoechsten Verschluesselungsstufe, die von
              Ihrem Browser unterstuetzt wird. Ob eine einzelne Seite unseres Internetauftrittes
              verschluesselt uebertragen wird, erkennen Sie an der geschlossenen Darstellung des
              Schluessel- beziehungsweise Schloss-Symbols in der Adressleiste Ihres Browsers.
            </p>
            <p>
              Passwoerter werden mittels branchenueblicher Hashing-Verfahren (bcrypt) gespeichert und
              sind fuer uns nicht einsehbar. Datenbankzugriffe sind durch Row Level Security (RLS)
          ...
          <section>
            ...
            <p>
              Personenbezogene Daten werden geloescht, sobald der Zweck der Speicherung entfaellt:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong>Kontodaten</strong> – bis zur Loeschung des Benutzerkontos durch den Nutzer</li>
              <li><strong>Berechnungsdaten</strong> – bis zur Loeschung durch den Nutzer oder Loeschung des Kontos</li>
              <li><strong>Abonnement-Daten</strong> – bis zur Beendigung des Abonnements plus gesetzliche Aufbewahrungsfristen (7 Jahre gemaess &sect; 132 BAO)</li>
          ...
          <section>
            ...
            <p>
              Ihnen stehen gemaess DSGVO und oesterreichischem Datenschutzgesetz (DSG) folgende Rechte zu:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong>Auskunftsrecht (Art. 15 DSGVO)</strong> – Sie haben das Recht, eine Bestaetigung darueber zu verlangen, ob personenbezogene Daten verarbeitet werden und Auskunft ueber diese Daten zu erhalten.</li>
              ...
              <li><strong>Recht auf Loeschung (Art. 17 DSGVO)</strong> – Sie haben das Recht, die Loeschung Ihrer personenbezogenen Daten zu verlangen.</li>
            ...
            <p>
              Zur Ausuebung Ihrer Rechte wenden Sie sich bitte per E-Mail an:{' '}
          ...
          {/* 13. Beschwerderecht */}
          <section>
            <h2 className="text-xl font-semibold mb-3">13. Beschwerderecht bei einer Aufsichtsbehoerde</h2>
            <p>
              Wenn Sie der Ansicht sind, dass die Verarbeitung Ihrer personenbezogenen Daten gegen die
              DSGVO verstoesst, haben Sie das Recht, Beschwerde bei der zustaendigen Aufsichtsbehoerde
              einzulegen:
            </p>
            <p>
              <strong>Oesterreichische Datenschutzbehoerde</strong><br />
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">14. Datenuebermittlung in Drittlaender</h2>
            <p>
              ...
              zur Erfullung unserer (vor)vertraglichen Pflichten, auf Grundlage Ihrer Einwilligung,
              aufgrund einer rechtlichen Verpflichtung oder auf Grundlage unserer berechtigten Interessen geschieht.
            </p>
            <p>
              Die Datenuebermittlung in die USA (Netlify, Lemon Squeezy) erfolgt auf Grundlage von
          ...
          {/* 15. Änderungen */}
          <section>
            <h2 className="text-xl font-semibold mb-3">15. Aenderungen dieser Datenschutzerklaerung</h2>
            <p>
              ...
              in der Datenschutzerklaerung umzusetzen. Fuer Ihren erneuten Besuch gilt dann die
