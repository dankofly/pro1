        ...
        <div className="max-w-3xl mx-auto px-6 py-8">
          <nav className="mb-8">
            <div className="flex items-center space-x-2 text-sm text-sb-mut">
              ...
              <span>›</span>
              <span className="text-sb-mut">Umsatzsteuer</span>
            </div>
          </nav>
          ...
          <article>
            ...
            <section className="mb-10">
              ...
              <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                <h3 className="text-lg font-semibold text-sb-text mb-2">Das Prinzip in einem Satz:</h3>
                <p className="text-sb-mut text-lg">
                  <strong className="text-sb-text">Zahllast = Umsatzsteuer (Ausgangsrechnungen) − Vorsteuer (Eingangsrechnungen)</strong>
                </p>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-sb-mut border border-sb-line rounded-lg overflow-hidden">
                  <thead className="bg-white/[0.05]">
                    <tr>
                      <th className="text-left p-3 text-sb-text">Steuersatz</th>
                      <th className="text-left p-3 text-sb-text">Höhe</th>
                      <th className="text-left p-3 text-sb-text">Anwendung</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-sb-line">
                    <tr className="bg-sb-card">
                      <td className="p-3 font-medium text-sb-text">Normalsteuersatz</td>
                    ...
                    <tr className="bg-sb-deep">
                      <td className="p-3 font-medium text-sb-text">Ermäßigter Satz</td>
            ...
            <section className="mb-10">
              ...
              <div className="bg-sb-card p-6 rounded-lg border border-sb-line mb-4">
                <h3 className="text-lg font-semibold text-sb-text mb-3">Voraussetzungen für den Vorsteuerabzug:</h3>
              ...
              <div className="bg-sb-card p-6 rounded-lg border border-sb-line">
                <h3 className="text-lg font-semibold text-sb-text mb-3">Rechenbeispiel:</h3>
                <div className="text-sb-mut space-y-1">
                  ...
                  <p className="border-t border-sb-line pt-2 mt-2">
                    <strong className="text-sb-text">USt-Zahllast:</strong> 2.000€ − 100€ − 240€ = 1.660€ ans Finanzamt
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-10">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-sb-mut border border-sb-line rounded-lg overflow-hidden">
                  <thead className="bg-white/[0.05]">
                    <tr>
                      <th className="text-left p-3 text-sb-text">Vorjahresumsatz</th>
                      <th className="text-left p-3 text-sb-text">UVA-Frequenz</th>
                      <th className="text-left p-3 text-sb-text">Frist</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-sb-line">
                    <tr className="bg-sb-card">
                      <td className="p-3">Über 100.000€</td>
                      <td className="p-3 font-medium text-sb-text">Monatlich</td>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-3">
                <div className="bg-sb-card p-4 rounded-lg border border-sb-line">
                  <p className="text-sb-mut">
                    <strong className="text-sb-text">B2B-Dienstleistungen innerhalb der EU:</strong> Wenn Sie
                ...
                <div className="bg-sb-card p-4 rounded-lg border border-sb-line">
                  <p className="text-sb-mut">
                    <strong className="text-sb-text">Innergemeinschaftlicher Erwerb:</strong> Beim Kauf von Waren
                    aus anderen EU-Ländern (B2B) ist die USt im Bestimmungsland (Österreich) zu entrichten.
                  </p>
                </div>
                <div className="bg-sb-card p-4 rounded-lg border border-sb-line">
                  <p className="text-sb-mut">
                    <strong className="text-sb-text">Bauleistungen (§ 19 Abs 1a UStG):</strong> Bei Bauleistungen
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4">
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="text-lg font-semibold text-sb-text mb-2">B2B innerhalb der EU</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="text-lg font-semibold text-sb-text mb-2">B2C innerhalb der EU (OSS)</h3>
                  <p className="text-sb-mut">
            ...
            <section className="mb-10">
              ...
              <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                <p className="text-sb-mut mb-3">Jede Rechnung über 400€ brutto muss enthalten:</p>
                <ul className="text-sb-mut space-y-2">
              ...
              <p className="text-sb-mut text-sm mt-3">
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4">
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-red mb-2">1. Falscher Steuersatz</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-red mb-2">2. Vorsteuer aus Bewirtungsbelegen</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-red mb-2">3. UVA-Fristen versäumt</h3>
                  <p className="text-sb-mut">
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Wie bekomme ich eine UID-Nummer?</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Kann ich die USt auch monatlich freiwillig melden?</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Was ist die Zusammenfassende Meldung (ZM)?</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Wie funktioniert die USt bei Drittlandgeschäften?</h3>
                  <p className="text-sb-mut">
