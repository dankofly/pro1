...
const glossarTerms = [
  ...
  { letter: 'E', terms: [
    { term: 'Einkommensteuer (ESt)', definition: 'Steuer auf das Einkommen natürlicher Personen. In Österreich progressiv: 0% bis 13.539€ (2026), dann stufenweise steigend bis 55% ab 1.000.000€. Selbstständige zahlen ESt auf ihren Gewinn.', link: '/steuerwissen/steueroptimierung-selbststaendige' },
  ...
  { letter: 'F', terms: [
    { term: 'FinanzOnline', definition: 'Das elektronische Portal des BMF für Steuererklärungen, UVA-Meldungen und Steuerkontoeinsicht. Für Unternehmer verpflichtend. Zugang über ID Austria oder Zugangskennungen.' },
    { term: 'FlexKap', definition: 'Flexible Kapitalgesellschaft — neue österreichische Rechtsform seit 2024. Mindestkapital: 10.000€ (wie bei der GmbH seit 1.1.2024). Verbindet GmbH-Haftungsschutz mit flexiblerer Gestaltung.', link: '/steuerwissen/gmbh-vs-einzelunternehmen' },
  ...
  { letter: 'G', terms: [
    ...
    { term: 'GmbH', definition: 'Gesellschaft mit beschränkter Haftung — juristische Person mit eigenem Vermögen. Mindeststammkapital: 10.000€ (seit 1.1.2024, davor 35.000€). Gewinne unterliegen der KöSt (23%), Ausschüttungen der KESt (27,5%).', link: '/steuerwissen/gmbh-vs-einzelunternehmen' },
  ...
  { letter: 'I', terms: [
    { term: 'Investitionsfreibetrag (IFB)', definition: 'Zusätzlicher Freibetrag nach § 11 EStG bei Anschaffung bestimmter Wirtschaftsgüter. 10% der Anschaffungskosten (15% bei ökologischen Investitionen); für Investitionen von November 2025 bis Ende 2026 befristet erhöht auf 20% bzw. 22%. Neben der regulären AfA absetzbar.', link: '/steuerwissen/gewinnfreibetrag-nutzen' },
  ]},
  { letter: 'K', terms: [
    { term: 'KESt (Kapitalertragsteuer)', definition: 'Steuer auf Kapitalerträge: 27,5% auf Dividenden, Kursgewinne und seit 2022 auch Krypto-Gewinne; Zinsen aus Geldeinlagen bei Banken (Sparbuch, Konto) nur 25%. Wird bei österreichischen Banken/Brokern automatisch einbehalten.', link: '/steuerwissen/krypto-steuer-oesterreich' },
    { term: 'Kleinunternehmerregelung', definition: 'USt-Befreiung für Unternehmer mit Jahresumsatz unter 55.000€ brutto (seit 2025, davor 35.000€ netto). Keine USt-Ausweisung, keine UVA-Pflicht, aber auch kein Vorsteuerabzug.', link: '/steuerwissen/kleinunternehmerregelung' },
    { term: 'Körperschaftsteuer (KöSt)', definition: 'Steuer auf Gewinne von juristischen Personen (GmbH, AG, FlexKap). Seit 2024 beträgt der KöSt-Satz 23% (2023: 24%, bis 2022: 25%). Entspricht der Einkommensteuer für natürliche Personen.', link: '/steuerwissen/gmbh-vs-einzelunternehmen' },
  ]},
  { letter: 'L', terms: [
  ...
  { letter: 'P', terms: [
    { term: 'Pauschalierung', definition: 'Vereinfachte Gewinnermittlung, bei der Betriebsausgaben als pauschaler Prozentsatz der Einnahmen angesetzt werden. Drei Arten: Basispauschalierung (ab 2026: 15%, bzw. 6% für bestimmte Tätigkeiten), Branchenpauschalierung, Kleinunternehmerpauschalierung (45%/20%).', link: '/steuerwissen/pauschalierung-oesterreich' },
    ...
    { term: 'Progressiver Steuertarif', definition: 'Das österreichische Einkommensteuer-System: Je höher das Einkommen, desto höher der Steuersatz. Stufen 2026: 0% (bis 13.539€), 20%, 30%, 40%, 48%, 50%, 55% (ab 1 Mio.€).' },
  ]},
  { letter: 'R', terms: [
  ...
  { letter: 'S', terms: [
    { term: 'Sonderausgaben', definition: 'Bestimmte private Ausgaben, die steuerlich absetzbar sind: Kirchenbeitrag (bis 600€ seit 2024), Spenden (bis 10% des Einkommens), Steuerberatungskosten. Seit 2021 stark eingeschränkt (Topfsonderausgaben ausgelaufen).' },
    { term: 'SVS (Sozialversicherung der Selbständigen)', definition: 'Die Sozialversicherungsanstalt für Gewerbetreibende und Freiberufler. Beitragssätze 2026: PV 18,50%, KV 6,80%, SV 1,53%, UV pauschal 12,96€/Monat.', link: '/steuerwissen/svs-beitraege-senken' },
  ]},
  { letter: 'U', terms: [
    ...
    { term: 'UVA (Umsatzsteuervoranmeldung)', definition: 'Regelmäßige Meldung der Umsatzsteuer an das Finanzamt. Monatlich (Vorjahresumsatz über 100.000€), vierteljährlich (bis 100.000€). Kleinunternehmer unter 55.000€ brutto sind von der UVA befreit (seit 2025).', link: '/steuerwissen/umsatzsteuer-selbstaendige' },
  ]},
  { letter: 'V', terms: [
