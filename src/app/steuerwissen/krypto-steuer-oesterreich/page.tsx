        ...
        <div className="max-w-3xl mx-auto px-6 py-8">
          <nav className="mb-8">
            <div className="flex items-center space-x-2 text-sm text-sb-mut">
              ...
              <span>›</span>
              <span className="text-sb-mut">Krypto-Steuer</span>
            </div>
          </nav>
          ...
          <article>
            ...
            <section className="mb-10">
              ...
              <div className="bg-sb-card p-5 rounded-lg border border-sb-line mb-4">
                <ul className="text-sb-mut space-y-2">
                  <li>• <strong className="text-sb-text">Steuersatz:</strong> 27,5% KESt auf realisierte Gewinne</li>
                  <li>• <strong className="text-sb-text">Steuersubjekt:</strong> Natürliche Personen mit Wohnsitz in Österreich</li>
                  <li>• <strong className="text-sb-text">Steuerobjekt:</strong> Kryptowährungen im Sinne des § 27b Abs 4 EStG</li>
                  <li>• <strong className="text-sb-text">Bemessungsgrundlage:</strong> Differenz zwischen Veräußerungserlös und Anschaffungskosten</li>
                  <li>• <strong className="text-sb-text">Spekulationsfrist:</strong> Entfällt — Gewinne sind immer steuerpflichtig</li>
                </ul>
              </div>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4">
                <div className="bg-sb-card p-5 rounded-lg border-l-4 border-sb-green/40">
                  <h3 className="text-lg font-semibold text-sb-text mb-2">Altbestand (vor 1. März 2021 angeschafft)</h3>
              ...
              <div className="overflow-x-auto mt-6">
                <table className="w-full text-sm text-sb-mut border border-sb-line rounded-lg overflow-hidden">
                  <thead className="bg-white/[0.05]">
                    <tr>
                      <th className="text-left p-3 text-sb-text">Anschaffung</th>
                      <th className="text-left p-3 text-sb-text">Veräußerung</th>
                      <th className="text-left p-3 text-sb-text">Besteuerung</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-sb-line">
                    <tr className="bg-sb-card">
                      ...
                      <td className="p-3 text-sb-green">Steuerfrei</td>
                    </tr>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4">
                <div className="bg-sb-red/10 border border-sb-red/30 p-5 rounded-lg">
                  <h3 className="text-lg font-semibold text-sb-red mb-3">Steuerpflichtige Vorgänge:</h3>
                  <ul className="text-sb-mut space-y-2">
                    <li>• <strong className="text-sb-text">Verkauf gegen Euro/Fiat:</strong> Differenz zwischen Verkaufspreis und Anschaffungskosten</li>
                    <li>• <strong className="text-sb-text">Bezahlung mit Krypto:</strong> Kauf von Waren/DL mit Krypto = Veräußerung</li>
                    <li>• <strong className="text-sb-text">Tausch gegen andere Wirtschaftsgüter:</strong> z.B. Krypto gegen Gold oder NFTs = Veräußerung</li>
                    <li>• <strong className="text-sb-text">Mining-Erträge:</strong> Laufende Einkünfte, KESt bei Zufluss (privat vs gewerblich unterschiedlich)</li>
                    <li>• <strong className="text-sb-text">Lending-Zinsen:</strong> Laufende Einkünfte, 27,5% KESt</li>
                  </ul>
                </div>

                <div className="bg-sb-green-soft border border-sb-green/30 p-5 rounded-lg">
                  <h3 className="text-lg font-semibold text-sb-green mb-3">NICHT steuerpflichtig:</h3>
                  <ul className="text-sb-mut space-y-2">
                    <li>• <strong className="text-sb-text">Halten (HODL):</strong> Unrealisierte Gewinne sind nicht steuerpflichtig</li>
                    <li>• <strong className="text-sb-text">Tausch Krypto gegen Krypto:</strong> Steuerneutral (Neuvermögen) - die Anschaffungskosten wandern auf die erhaltene Kryptowährung</li>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="text-lg font-semibold text-sb-text mb-2">Mining</h3>
                  <p className="text-sb-mut mb-2">
                    Beim Mining muss unterschieden werden:
                  </p>
                  <ul className="text-sb-mut space-y-1 ml-4">
                    <li>• <strong className="text-sb-text">Privates Mining:</strong> Einkünfte aus Kryptowährungen, 27,5% KESt</li>
                    <li>• <strong className="text-sb-text">Gewerbliches Mining:</strong> Einkünfte aus Gewerbebetrieb, progressiver Einkommensteuertarif (bis 55%)</li>
                  </ul>
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="text-lg font-semibold text-sb-text mb-2">Airdrops</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="text-lg font-semibold text-sb-text mb-2">DeFi (Decentralized Finance)</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="text-lg font-semibold text-sb-text mb-2">NFTs (Non-Fungible Tokens)</h3>
                  <p className="text-sb-mut">
            ...
            <section className="mb-10">
              ...
              <div className="bg-sb-card p-5 rounded-lg border border-sb-line mb-4">
                <h3 className="text-lg font-semibold text-sb-text mb-2">Verrechenbar mit:</h3>
                <ul className="text-sb-mut space-y-2">
              ...
              <div className="bg-sb-red/10 border border-sb-red/30 p-4 rounded-lg mb-4">
                <h3 className="font-semibold text-sb-red mb-2">NICHT verrechenbar mit:</h3>
              ...
              <div className="bg-sb-card p-6 rounded-lg border border-sb-line">
                <h3 className="text-lg font-semibold text-sb-text mb-3">Rechenbeispiel Verlustausgleich:</h3>
                <div className="text-sb-mut space-y-1">
                  <p>Bitcoin-Gewinn: +5.000€</p>
                  <p>Ethereum-Verlust: -3.000€</p>
                  <p>Aktien-Dividenden: +2.000€</p>
                  <p className="border-t border-sb-line pt-2 mt-2">
                    <strong className="text-sb-text">Steuerpflichtiger Saldo:</strong> 5.000 - 3.000 + 2.000 = 4.000€
                  </p>
                  <p><strong className="text-sb-text">KESt (27,5%):</strong> 1.100€</p>
                  <p className="text-sb-mut text-sm mt-2">
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4">
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-red mb-2">1. Krypto-zu-Krypto-Tausch fälschlich versteuert</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-red mb-2">2. DeFi-Erträge vergessen</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-red mb-2">3. Keine oder falsche Dokumentation</h3>
                  <p className="text-sb-mut">
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4">
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Muss ich jeden einzelnen Trade melden?</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Was ist mit Krypto auf ausländischen Börsen?</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Gibt es eine Freigrenze für Krypto-Gewinne?</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Kann ich Krypto an meine Kinder verschenken, um Steuern zu sparen?</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Wie behandle ich Hard Forks?</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Muss mein österreichischer Broker die KESt automatisch abführen?</h3>
                  <p className="text-sb-mut">
