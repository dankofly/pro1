        ...
        <div className="max-w-3xl mx-auto px-6 py-8">
          ...
          <nav className="mb-8">
            <div className="flex items-center space-x-2 text-sm text-sb-mut">
              ...
              <span>›</span>
              <span className="text-sb-mut">SVS-Nachzahlung vermeiden</span>
            </div>
          </nav>
          ...
          <article>
            ...
            <section className="mb-10">
              ...
              <div className="bg-sb-card p-5 rounded-lg border border-sb-line mb-4">
                <h3 className="text-lg font-semibold text-sb-text mb-3">SVS-Beitragssätze 2026:</h3>
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-sb-card p-4 rounded-lg border-l-4 border-sb-accent/40">
                  <p className="text-sb-mut">
                    <strong className="text-sb-text">Jahr 1 (Beitragsjahr):</strong> Du zahlst vorläufige
                ...
                <div className="bg-sb-card p-4 rounded-lg border-l-4 border-sb-accent/40">
                  <p className="text-sb-mut">
                    <strong className="text-sb-text">Jahr 2 (Steuererklärung):</strong> Du gibst deine
                ...
                <div className="bg-sb-card p-4 rounded-lg border-l-4 border-sb-accent">
                  <p className="text-sb-mut">
                    <strong className="text-sb-text">Jahr 2-3 (Datenweitergabe):</strong> Das Finanzamt
              ...
              <div className="overflow-x-auto mb-6">
                <table className="w-full text-sm text-sb-mut border border-sb-line rounded-lg overflow-hidden">
                  <thead className="bg-white/[0.05]">
                    <tr>
                      <th className="text-left p-3 text-sb-text">Geschätzt</th>
                      <th className="text-left p-3 text-sb-text">Tatsächlich</th>
                      <th className="text-left p-3 text-sb-text">Differenz</th>
                  ...
                  <tbody className="divide-y divide-sb-line">
                    <tr className="bg-sb-card">
                      ...
                      <td className="p-3">20.000€</td>
                      <td className="p-3 font-semibold text-sb-red">~5.366€</td>
                    </tr>
                    <tr className="bg-sb-deep">
                      <td className="p-3">30.000€</td>
                      <td className="p-3">60.000€</td>
                      <td className="p-3">30.000€</td>
                      <td className="p-3 font-semibold text-sb-red">~8.049€</td>
                    </tr>
                    <tr className="bg-sb-card">
                      <td className="p-3">40.000€</td>
                      <td className="p-3">80.000€</td>
                      <td className="p-3">40.000€</td>
                      <td className="p-3 font-semibold text-sb-red">~10.732€</td>
                    </tr>
                    <tr className="bg-sb-deep">
                      <td className="p-3">50.000€</td>
                      <td className="p-3">100.000€</td>
                      <td className="p-3">50.000€</td>
                      <td className="p-3 font-semibold text-sb-red">~13.415€</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section className="mb-10">
              ...
              <div className="bg-sb-card p-5 rounded-lg border border-sb-line mb-4">
                <h3 className="text-lg font-semibold text-sb-text mb-3">Steuerersparnis durch SVS-Abzug:</h3>
                <div className="text-sb-mut space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <strong className="text-sb-green">4.800€ ESt-Ersparnis</strong>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-sb-card p-6 rounded-lg border border-sb-line">
                  ...
                  <div className="bg-white/[0.05] p-4 rounded-lg">
                    <h4 className="font-semibold text-sb-text mb-2">So geht&apos;s:</h4>
                    <ol className="text-sb-mut space-y-1 list-decimal list-inside">
                ...
                <div className="bg-sb-card p-6 rounded-lg border border-sb-line">
                  ...
                  <div className="bg-white/[0.05] p-4 rounded-lg">
                    <h4 className="font-semibold text-sb-text mb-2">Rechenbeispiel:</h4>
                    <p className="text-sb-mut">
                      Geschätzter Gewinn: 40.000€, tatsächlicher Gewinn: 70.000€.<br />
                      Mehrgewinn: 30.000€ → monatliche Rücklage: 30.000€ × 26,83% ÷ 12 = <strong className="text-sb-text">~671€/Monat</strong>
                    </p>
                  </div>
                </div>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">3. Ratenzahlung oder Stundung beantragen</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">4. Härtefallantrag prüfen</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">5. Zukunftsvorsorge treffen</h3>
                  <p className="text-sb-mut">
              ...
              <div className="bg-sb-card p-6 rounded-lg border border-sb-line">
                <ul className="text-sb-mut space-y-3">
                  <li className="flex items-start gap-3">
                    <span className="text-sb-green mt-0.5">&#9744;</span>
            ...
            <section className="mb-10">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Fallen Verzugszinsen auf die Nachzahlung an?</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Was passiert wenn ich die Nachzahlung nicht zahlen kann?</h3>
                  <p className="text-sb-mut">
                ...
                <div className="bg-sb-card p-5 rounded-lg border border-sb-line">
                  <h3 className="font-semibold text-sb-text mb-2">Bekomme ich eine Gutschrift wenn mein Gewinn sinkt?</h3>
                  <p className="text-sb-mut">
